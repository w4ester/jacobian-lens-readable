# Instructions à copier-coller (Français)

Vous n'avez pas besoin d'écrire de code. Copiez l'un des blocs ci-dessous et collez-le dans votre
assistant IA (Claude, ChatGPT ou Gemini). Grâce à la première ligne, l'assistant vous expliquera et
vous guidera **en français** pendant toute la session.

## 1. Installation (installe tout et exécute le premier exemple)

```text
Réponds-moi en français pendant toute la session et explique chaque étape en français.
...
## 2. Guide du graphique (qu'un modèle vous explique ce que vous voyez)

```text
Réponds-moi en français pendant toute la session et explique tout en français.
...
---
Les traductions sont un premier effort ; les corrections sont bienvenues via un fork.
