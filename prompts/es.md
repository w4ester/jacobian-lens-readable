# Instrucciones para copiar y pegar (Español)

No necesitas escribir código. Copia uno de los bloques de abajo y pégalo en tu asistente de IA
(Claude, ChatGPT o Gemini). Gracias a la primera línea, el asistente te explicará y te guiará
**en español** durante toda la sesión.

## 1. Instalación (instala todo y ejecuta el primer ejemplo)

```text
Responde en español durante toda la sesión y explícame cada paso en español.
...
## 2. Guía del gráfico (que un modelo te explique lo que ves)

```text
Responde en español durante toda la sesión y explícame todo en español.
...
---
Las traducciones son un primer esfuerzo; se agradecen las correcciones mediante un fork.
