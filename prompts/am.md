# ገልብጠህ የምትለጥፋቸው ጥያቄዎች (አማርኛ)

ኮድ መጻፍ አያስፈልግህም። ከታች ካሉት ማገጃዎች አንዱን ገልብጠህ ወደ AI ረዳትህ (Claude፣ ChatGPT ወይም
Gemini) ለጥፍ። በመጀመሪያው መስመር ምክንያት ረዳቱ በጠቅላላው ክፍለ ጊዜ በ**አማርኛ** ያብራራልሃል፣ ይመራሃል።

## 1. መጫን (ሁሉንም ጫን እና የመጀመሪያውን ምሳሌ አሂድ)

```text
በጠቅላላው ክፍለ ጊዜ በአማርኛ መልስልኝ፣ እያንዳንዱን ደረጃም በአማርኛ አብራራልኝ።
...
## 2. የግራፍ መመሪያ (ሞዴል የምታየውን እንዲያብራራልህ)

```text
በጠቅላላው ክፍለ ጊዜ በአማርኛ መልስልኝ፣ ሁሉንም ነገር በአማርኛ አብራራልኝ።
...
---
ትርጉሞቹ የመጀመሪያ ሙከራ ናቸው፤ በfork አማካኝነት እርማቶች እንኳን ደህና መጡ።
