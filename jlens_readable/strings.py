...
LANDING = {
    "en": {
        ...
        "demos_h": "Live demos",
        "demos_sub": "All run on the open Qwen3.5-4B model with Anthropic's public lens.",
    ...
    "es": {
        ...
        "demos_sub": "Todas se ejecutan con el modelo abierto Qwen3.5-4B y el lente público de Anthropic.",
    ...
    "fr": {
        ...
        "demos_sub": "Toutes utilisent le modèle ouvert Qwen3.5-4B et la lentille publique d'Anthropic.",
    ...
    "zh": {
        ...
        "howto_h": "如何阅读表格",
        "demos_h": "在线演示",
        "demos_sub": "全部运行于开放的 Qwen3.5-4B 模型和 Anthropic 的公开透镜。",
        "prompts_h": "自己安全地试一试",
    ...
    "am": {
        ...
        "demos_h": "ቀጥታ ማሳያዎች",
        "demos_sub": "ሁሉም በክፍት Qwen3.5-4B ሞዴልና በAnthropic ይፋዊ ሌንስ ይሠራሉ።",
